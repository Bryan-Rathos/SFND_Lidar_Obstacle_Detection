...
std::unordered_set<int> Ransac(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int maxIterations, float distanceTol)
{
	...
	while(maxIterations--)
	{	
		// Randomly pick two points from the 2D point cloud
		// We use unordered set to select two points since this will avoid choosing repaeated points
		// We check the set size in the while loop to check once the 2 point selection is done
